...
const colorMap = {
  ...
  "pending-deliveries": { bg: "bg-brand-100 text-brand-800", stroke: "#2f8159" },
  "low-stock-products": { bg: "bg-brand-100 text-brand-900", stroke: "#1d5038" },
  "avg-order-value": { bg: "bg-brand-50 text-brand-800", stroke: "#2f8159" },
  "conversion-rate": { bg: "bg-brand-100 text-brand-900", stroke: "#246646" },
  "avg-session-duration": { bg: "bg-brand-50 text-brand-700", stroke: "#57a47b" },
  "cart-abandonment": { bg: "bg-brand-100 text-brand-800", stroke: "#2f8159" },
  "pending-deliveries-insight": { bg: "bg-brand-100 text-brand-800", stroke: "#2f8159" },
